...
if __name__ == '__main__':
    ...
    notes = [
        r'https://www.xiaohongshu.com/explore/67e611ef000000000903956b?xsec_token=ABRGWzt-2mW6vwUL-jFazVH6vD4Rzy1snUBUm0h-JKM1Q=&xsec_source=pc_search&source=web_explore_feed',
    ]
    data_spider.spider_some_note(notes, cookies_str, base_path, 'all', "test_01")